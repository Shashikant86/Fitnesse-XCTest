#!/bin/bash
SLIM_PORT=$1
TEST_RUNNER_SCRIPT=/Users/Shashi/iOS/XCFitnesse/Pods/OCSlimProject/Pod/Support/SharedSupport/../iOS/RunTestsTargetWithSlimPort
ENV_FILE_PATH=/Users/Shashi/Library/Developer/Xcode/DerivedData/XCFitnesse-ezunjxxstpqgvufgzyhawbivgnss/Build/Products/Debug-iphonesimulator/AcceptanceTest.app/OCSlimProject.bundle/env.sh
